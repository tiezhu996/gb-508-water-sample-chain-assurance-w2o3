...
type LabSampleHandler struct{ service service.LabSampleService }

func NewLabSampleHandler(s service.LabSampleService) *LabSampleHandler {
	return &LabSampleHandler{service: s}
}

func (h *LabSampleHandler) Register(group *gin.RouterGroup) {
...
func (h *LabSampleHandler) transition(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
...
func (h *LabSampleHandler) remove(c *gin.Context) {
